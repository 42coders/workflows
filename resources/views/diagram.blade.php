...
<script>
    ...
    function loadResourceIntelligence(element_id, type, value, field_name, element) {
        ...
        $.ajax({
            type: "POST",
            url: "/workflow/{{$workflow->id}}/loadResourceIntelligence",
            dataType: 'json',
            data: {
                'resource': resource,
    ...
    function saveFields(id, type) {
        ...
        $.ajax({
            type: "POST",
            url: "/workflow/{{$workflow->id}}/changeValues",
            dataType: 'text',
            data: {
                'data': data,
                'type': type,
    ...
    editor.on('nodeCreated', function (node) {
        ...
        switch (node.data.type) {
            case 'task':
                $.ajax({
                    type: "POST",
                    url: "/workflow/{{$workflow->id}}/addTask",
                    data: node,
                    dataType: "json",
            ...
            case 'trigger':
                $.ajax({
                    type: "POST",
                    url: "/workflow/{{$workflow->id}}/addTrigger",
                    data: node,
                    dataType: "json",
                    success: function (data) {
    ...
    editor.on('nodeBeforeRemoved', function (id) {
        ...
        $.ajax({
            type: "POST",
            url: "/workflow/{{$workflow->id}}/removeTask",
            data: {
                node: node
            },
            dataType: "json",
    ...
    function updateNodePosition(node) {
        ...
        $.ajax({
            type: "POST",
            url: "/workflow/{{$workflow->id}}/updateNodePosition",
            data: {
                node: node
            },
            dataType: "json",
    ...
    editor.on('connectionCreated', function (connection) {
        ...
        $.ajax({
            type: "POST",
            url: "/workflow/{{$workflow->id}}/addConnection",
            data: {
    ...
    editor.on('connectionRemoved', function (connection) {
        $.ajax({
            type: "POST",
            url: "/workflow/{{$workflow->id}}/removeConnection",
            data: connection,
            dataType: "json",
            success: function (data) {
                console.log(data);
    ...
    function loadSettings(type, element_id = 0, element){
        ...
        $.ajax({
            type: "POST",
            url: "/workflow/{{$workflow->id}}/getElementSettings",
            data: {
                type: type,
                element_id: element_id,
            },
